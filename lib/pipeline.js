...
function canonicalFormat(format) {
  ...
  const names = {
    code39: 'Code39', code39std: 'Code39', code39ext: 'Code39',
    code93: 'Code93', code128: 'Code128', codabar: 'Codabar',
...
module.exports = { loadNormalized, decodeAll, thumbnail, toImageData, canonicalFormat };
